...
if (isset($_POST['add_to_cart']))
{
	...
	// If item is already in cart notify user
...
if (isset($_GET['view_product']))
{
	...
	{
		// Display site link's
		echo "<p> <a href = './index.php'> WB </a> & gt; <a href = './index.php'>" . 
		$products[$product_id]['category'] . "</a> </p>";
		
		// Display product
		echo "<p> <span style = 'font-weight:bold;'>" . $products[$product_id]['name'] . "</span> <br />
...
{
	// Display site link's
	echo "<p> <a href = './index.php'> WB </a> </p>";
	
	echo "<h3> Your Cart </h3>
	<p> <a href = './index.php?empty_cart=1'> Empty Cart </a> </p>";
			...
			foreach($_SESSION['shopping_cart'] as $id => $product)
			{
				$product_id = $product['product_id'];
					...
					<tr>
						...
						<input type = 'text' name = 'quantity[$product_id]' 
